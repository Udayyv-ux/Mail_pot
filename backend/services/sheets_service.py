...
async def get_sheet_data(sheet_url_or_id: str, credentials_json: str) -> tuple[str, list]:
    """Connect to Google Sheets and return the extracted ID and records."""
    if not sheet_url_or_id or not credentials_json:
        raise ValueError("Missing sheet ID or credentials")
...
async def update_sheet_cell(sheet_id: str, credentials_json: str, row: int, col: int, value: str):
